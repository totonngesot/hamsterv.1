...
🐹HAMSTER🐹
    ...
    print(Fore.GREEN + Style.BRIGHT + "BOT BUAT ORANG ORANG YANG TERSAKITI ")
    print(Fore.YELLOW + Style.BRIGHT + "Free")
    print(Fore.BLUE + Style.BRIGHT + "Buy me a coffee :) 0819 3996 8284 GOPAY / DANA")
    print(Fore.RED + Style.BRIGHT + "NOT FOR SALE ! DIKIT AJA KU RINAME :)\n\n")
